...
```razor title="TabsIconAndTextExample"
...
```razor title="TabsPositionExample"
...
```razor title="TabsCenteredExample"
...
TabPanels appear in the order they are processed by the RenderTreeBuilder, which can be affected by component nesting in complex scenarios.
 Use the `SortDirection` property to sort lexicographically by `Text`.
...
```razor title="TabsSortByTextExample"
<MudTabs SortDirection="SortDirection.Descending" Elevation="2" Rounded="true" ApplyEffectsToContainer="true" TabPanelsClass="pa-6">
...
The TabPanel's `SortKey` property is used in preference to the `Text` property, if set.

```razor title="TabsSortBySortKeyExample"
<MudTabs SortDirection="SortDirection.Ascending" Elevation="2" Rounded="true" ApplyEffectsToContainer="true" TabPanelsClass="pa-6">
...
Specify a custom `SortComparer` which implements `IComparer<MudTabPanel>` to
 override the default sorting behaviour. In this scenario, sort direction must be handled by the custom SortComparer.

```razor title="TabsSortByComparerExample"
<MudTabs SortComparer="_customComparer" Elevation="2" Rounded="true" ApplyEffectsToContainer="true" TabPanelsClass="pa-6">
...
```razor title="TabsMinimumTabWidthExample"
<MudStack>
...
```razor title="TabsToolTipExample"
<MudTabs>
...
```razor title="TabsWithBagdesExample"
...
Tab reordering can be enabled by setting `EnableDragAndDrop` to `true`.
 ...
 An event is available that fires after a drag-and-drop operation is completed: `OnItemDropped`, which contains the original details of the operation.

```razor title="TabsDragAndDropExample"
...
```razor title="TabsScrollExample"
<MudTabs Elevation="4" Color="@Color.Secondary">
    <MudTabPanel Text="One" />
    <MudTabPanel Text="Two" />
    <MudTabPanel Text="Three" />
    <MudTabPanel Text="Four" />
...
```razor title="TabsCustomScrollIconsExample"
<MudTabs Elevation="4" Color="@Color.Success" PrevIcon="@Icons.Material.Filled.SkipPrevious" NextIcon="@Icons.Material.Filled.SkipNext">
    <MudTabPanel Text="One" />
    <MudTabPanel Text="Two" />
    <MudTabPanel Text="Three" />
    <MudTabPanel Text="Four" />
...
```razor title="TabsContentExample"
<MudTabs Elevation="1" Rounded="true" TabPanelsClass="pa-6" ActiveTabClass="border-solid border-2 mud-border-primary">
    <MudTabPanel>
        <ChildContent>
...
The `Visible` property defines whether the tab is visible or hidden.

```razor title="TabsVisibleExample"
<div class="d-flex flex-column align-center gap-3">
    <MudTabs>
        <MudTabPanel Text="Item One" />
        <MudTabPanel Text="Item Two" Visible="@_visible" />
        <MudTabPanel Text="Item Three" />
    </MudTabs>

    <MudSwitch @bind-Value="_visible" Label="Tab Two Visible" Color="Color.Primary" />
</div>
...
```razor title="TabsSetActiveExample"
<MudTabs Elevation="1" Rounded="true" @ref="_tabs">
    <MudTabPanel Text="One" @ref="_panel01" ID="@("pn_one")" />
    <MudTabPanel Text="Two" @ref="_panel02" ID="@("pn_two")" />
    <MudTabPanel Text="Three" @ref="_panel03" ID="@("pn_three")" />
</MudTabs>

<MudText GutterBottom="true" Align="Align.Center" Class="mt-8"><b>Set Active by Index</b></MudText>
<div class="d-flex justify-center">
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick="() => ActivateAsync(0)">Index 0</MudButton>
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick="() => ActivateAsync(1)" Class="mx-2">Index 1</MudButton>
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick="() => ActivateAsync(2)">Index 2</MudButton>
</div>
<MudText GutterBottom="true" Align="Align.Center" Class="mt-4"><b>Set Active by Instance</b></MudText>
<div class="d-flex justify-center">
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick="() => ActivateAsync(_panel01)">Item One</MudButton>
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick="() => ActivateAsync(_panel02)" Class="mx-2">Item Two</MudButton>
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick="() => ActivateAsync(_panel03)">Item Three</MudButton>
</div>
<MudText GutterBottom="true" Align="Align.Center" Class="mt-4"><b>Set Active by TabPanel ID</b></MudText>
<div class="d-flex justify-center">
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick='() => ActivateAsync("pn_one")'>Item One</MudButton>
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick='() => ActivateAsync("pn_two")' Class="mx-2">Item Two</MudButton>
    <MudButton Variant="@Variant.Filled" Color="Color.Primary" OnClick='() => ActivateAsync("pn_three")'>Item Three</MudButton>
</div>

@code {
    private MudTabs _tabs = null!;
    private MudTabPanel _panel01 = null!;
    private MudTabPanel _panel02 = null!;
    private MudTabPanel _panel03 = null!;
    ...
    private Task ActivateAsync(MudTabPanel panel)
    {
        return _tabs.ActivatePanelAsync(panel);
    }

    private Task ActivateAsync(object id)
    {
        return _tabs.ActivatePanelAsync(id);
    }
}
```
...
```razor title="TabsBindingExample"
...
```razor title="DynamicTabsSimpleExample"
...
```razor title="CustomDynamicTabsExample"
...
By default, tab panels are removed when switching to another tab and rerendered once the tab is selected again.
 This behavior can be changed by setting the `KeepPanelsAlive` property to `true`. Then, all tabs are rendered at once and inactive tab panels only get hidden but not destroyed.
 The `LazyLoadPanels` property additionally allows rendering tab panels only once they get activated. This property requires `KeepPanelsAlive` to also be `true`.

```razor title="TabsKeepPanelsAliveExample"
...
```razor title="TabsKeepAlivePanel"
