...
```razor title="AppBarSimpleExample"
...
```razor title="AppBarUsageExample"
...
```razor title="AppBarBottomExample"
@layout IframeLayout

@page "/iframe/docs/examples/appbar/bottom"
...
```razor title="AppBarContextualExample"
<MudLayout>
