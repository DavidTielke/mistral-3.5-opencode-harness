...
```razor title="RadioGroupColorExample"
<MudRadioGroup T="int">
...
```razor title="RadioContentPlacementExample"
<MudGrid>
    <MudItem xs="12" md="1">
...
```razor title="RadioReadOnlyDisabledExample"
<MudGrid>
    <MudItem sm="12" md="6">
...
A `MudRadioGroup` accepts the following shortcuts:
 ...
 Move focus into or out of the radio group

 `Enter`,
 `NumpadEnter`,
 `Space`
 
 Select the focused radio button
