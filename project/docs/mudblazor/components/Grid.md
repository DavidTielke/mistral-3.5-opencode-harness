...
```razor title="GridSpacingExample"
...
```razor title="GridWithBreakpointsExample"
<MudGrid>
    <MudItem xs="12">
        <MudPaper Class="d-flex align-center justify-center mud-width-full py-8">xs=12</MudPaper>
    </MudItem>
...
```razor title="GridLineBreakExample"
<MudGrid>
    <MudItem xs="6">
...
```razor title="GridBuilderExample"
<MudGrid>
    <MudItem xs="12">
